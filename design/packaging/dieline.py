...
BOXES = [
    ("01", "1 мл",  14.0, 14.0, 52.0, "пробник-капля, Ø7 × 45 мм",        "S"),
    ("05", "5 мл",  20.0, 20.0, 78.0, "спрей-атомайзер, Ø16 × 72 мм",     "M"),
    ("10", "10 мл", 24.0, 24.0, 94.0, "спрей-атомайзер, Ø19 × 88 мм",     "L"),
]
...
def build(key, label, W, D, H, vial, weight):
    ...
    pill_w, pill_h = W * 0.62, max(6.0, H * 0.095)
